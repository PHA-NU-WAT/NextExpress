...
function SortableRoot<T>(props: SortableRootProps<T>) {
  ...
  // ✅ destructure handler ที่ใช้จริงออกมาก่อน
  const { onDragStart: handleDragStart, onDragEnd: handleDragEnd, onDragCancel: handleDragCancel } =
    sortableProps;
  ...
  // ✅ ใช้ตัวแปรที่ destructure แล้วแทน sortableProps.onDragStart
  ...
  const onDragEnd = React.useCallback(
    ...
    [handleDragEnd, value, onMove, onValueChange, getItemValue],
  );
