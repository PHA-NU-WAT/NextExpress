...
function LoginForm({ className, ...props }) {
    ...
    ;
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$provider$2f$AuthProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    async function handleLogin(email, password) {
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "https://core.pcshs.online")}/api/login`, {
                method: "POST",
                headers: {
            ...
            login(data.user);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success("Login สำเร็จ!");
            setTimeout(()=>router.push(redirectPath), 1000);
        } catch (err) {
            console.error("❌ Login error:", err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("Login ไม่สำเร็จ! " + (err instanceof Error ? err.message : ""));
        }
    }
...
_s(LoginForm, "2q7eexj4z/4mokmSwBNDwK6lphg=", false, function() {
    return [
...
//# sourceMappingURL=src_175d5b63._.js.map