...
function LoginForm({ className, ...props }) {
    ...
    ;
    const { login } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$provider$2f$AuthProvider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    async function handleLogin(email, password) {
        try {
            ...
            login(data.user);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].success("Login สำเร็จ!");
            setTimeout(()=>router.push(redirectPath), 1000);
        } catch (err) {
            console.error("❌ Login error:", err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error("Login ไม่สำเร็จ! " + (err instanceof Error ? err.message : ""));
        }
    }
...
//# sourceMappingURL=src_98558e61._.js.map