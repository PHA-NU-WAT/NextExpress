...
// ============================================
async function FetchStudents(body) {
    console.log("FetchStudents body:", body);
    const query = body;
    const qs = new URLSearchParams(query).toString();
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$callBackend$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["callBackend"])(`/api/students/fetch?${qs}`, body, "GET");
...
async function EditStudent(body) {
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$callBackend$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["callBackend"])("/api/students/edit", body, "POST");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df5d8460._.js.map